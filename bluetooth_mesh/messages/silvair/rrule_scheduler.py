...
from bluetooth_mesh.messages.util import Opcode, SwitchStruct, SetAdapter
...
ScheduleRegisterEntryStatus = Struct(
    "entry_id" / Int8ul,
    "status" / EnumAdapter(Int8ul, StatusCodes),
    "scheduler_register_entry" / Optional(SchedulerRegisterEntry),
)
