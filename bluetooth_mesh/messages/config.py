...
class GATTNamespaceDescriptor(enum.IntEnum):
    ...
    FOURTEENTH = 0x000e,
    FOURTH = 0x0004,
    FOURTY_EIGHTH = 0x0030,
    FOURTY_FIFTH = 0x002d,
    FOURTY_FIRST = 0x0029,
    FOURTY_FOURTH = 0x002c,
    FOURTY_NINETH = 0x0031,
    FOURTY_SECOND = 0x002a,
    FOURTY_SEVENTH = 0x002f,
    FOURTY_SIXTH = 0x002e,
    FOURTY_THIRD = 0x002b,
    FRONT = 0x0100,
    INSIDE = 0x010B,
    ...
    ONE_HUNDRED_AND_EIGHTY_NINETH = 0x00bd,
    ...
    ONE_HUNDRED_AND_FIFTY_NINETH = 0x009f,
    ...
    ONE_HUNDRED_AND_FOURTY_EIGHTH = 0x0094,
    ONE_HUNDRED_AND_FOURTY_FIFTH = 0x0091,
    ONE_HUNDRED_AND_FOURTY_FIRST = 0x008d,
    ONE_HUNDRED_AND_FOURTY_FOURTH = 0x0090,
    ONE_HUNDRED_AND_FOURTY_NINETH = 0x0095,
    ONE_HUNDRED_AND_FOURTY_SECOND = 0x008e,
    ONE_HUNDRED_AND_FOURTY_SEVENTH = 0x0093,
    ONE_HUNDRED_AND_FOURTY_SIXTH = 0x0092,
    ONE_HUNDRED_AND_FOURTY_THIRD = 0x008f,
    ONE_HUNDRED_AND_NINETEENTH = 0x0077,
    ONE_HUNDRED_AND_NINETH = 0x006d,
    ...
    ONE_HUNDRED_AND_NINETY_NINETH = 0x00c7,
    ...
    ONE_HUNDRED_AND_SEVENTY_NINETH = 0x00b3,
    ...
    ONE_HUNDRED_AND_SIXTY_NINETH = 0x00a9,
    ...
    ONE_HUNDRED_AND_THIRTY_NINETH = 0x008b,
    ...
    ONE_HUNDRED_AND_TWENTY_NINETH = 0x0081,
    ...
    TWO_HUNDRED_AND_FOURTY_EIGHTH = 0x00f8,
    TWO_HUNDRED_AND_FOURTY_FIFTH = 0x00f5,
    TWO_HUNDRED_AND_FOURTY_FIRST = 0x00f1,
    TWO_HUNDRED_AND_FOURTY_FOURTH = 0x00f4,
    TWO_HUNDRED_AND_FOURTY_NINETH = 0x00f9,
    TWO_HUNDRED_AND_FOURTY_SECOND = 0x00f2,
    TWO_HUNDRED_AND_FOURTY_SEVENTH = 0x00f7,
    TWO_HUNDRED_AND_FOURTY_SIXTH = 0x00f6,
    TWO_HUNDRED_AND_FOURTY_THIRD = 0x00f3,
    TWO_HUNDRED_AND_NINETEENTH = 0x00db,
    TWO_HUNDRED_AND_NINETH = 0x00d1,
    ...
    TWO_HUNDRED_AND_THIRTY_NINETH = 0x00ef,
    ...
    TWO_HUNDRED_AND_TWENTY_NINETH = 0x00e5,
